...
class ApiTwitch:
    ...
    def __init__(self, username) :
        ...
        url=('https://api.twitch.tv/helix/users?login='+ username.lower())

        head = {"Accept": "application/vnd.twitchtv.v5+json", "Authorization" : "Bearer ny3a6p6yezigagpms9pi1tm7d8gk41" ,"Client-ID" : "os2kmdts5tvcojd34pguyzsn3eyn5q"} # en-tete de la requete
